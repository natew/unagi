"use strict";
var import_FileRoutes_server = require("../FileRoutes/FileRoutes.server.js");
const STUB_MODULE = { default: {}, api: null };
it("converts normal pages to routes", () => {
  const pages = {
    "./routes/contact.server.jsx": STUB_MODULE
  };
  const routes = (0, import_FileRoutes_server.createPageRoutes)(pages, "*", "./routes");
...
it("factors in the top-level path prefix", () => {
  ...
  const routes = (0, import_FileRoutes_server.createPageRoutes)(pages, "/foo/*", "./routes");
  expect(routes).toEqual([
    {
      path: "/foo/contact",
      component: STUB_MODULE.default,
...
it("uses a custom file directory path", () => {
  ...
  const routes = (0, import_FileRoutes_server.createPageRoutes)(pages, "*", "./custom");
  expect(routes).toEqual([
    {
      path: "/contact",
      component: STUB_MODULE.default,
