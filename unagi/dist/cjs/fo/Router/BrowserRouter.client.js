...
var import_ssr_interop = require("../ssr-interop.js");
var import_use_server_props = require("../useServerProps/use-server-props.js");
const RouterContext = (0, import_react.createContext)(void 0);
let isFirstLoad = true;
const positions = {};
const BrowserRouter = ({ history: pHistory, children }) => {
  if (import_ssr_interop.META_ENV_SSR)
  ...
  const { pending, locationServerProps, setLocationServerProps } = (0, import_use_server_props.useInternalServerProps)();
