...
var UnagiRequest_server_exports = {};
__export(UnagiRequest_server_exports, {
  UnagiRequest: () => UnagiRequest
});
module.exports = __toCommonJS(UnagiRequest_server_exports);
...
const PRELOAD_ALL = "*";
class UnagiRequest extends Request {
  ...
  async formData() {
    if (__UNAGI_WORKER__ || super.formData)
...
//# sourceMappingURL=UnagiRequest.server.js.map
